...
| № <br/>п/п | Наименование алгоритма           | Acuracy            | Recall             | F1 Score          |
|------------|----------------------------------|--------------------|--------------------|-------------------|
| 1          | RandomForestClassifier(BaseLine) | 0.8645601212229254 | 0.5855144751129202 | 0.618194096184349 |

Качество модели на leaderboard:

| № <br/>п/п | Наименование алгоритма           | Score |
|------------|----------------------------------|-------|
| 1          | RandomForestClassifier(BaseLine) |0.500108|
|            |                                  |       |
|            |                                  |       |
