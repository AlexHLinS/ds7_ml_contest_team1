...
| 11  | CatBoost                         | iterations=52, eval_metric='AUC', cat_features=category_columns,learning_rate=0.1                        | Первая итерация                                                                  | 0.792                            | .........              |
| 12  | CatBoost                         | iterations=42, eval_metric='AUC', cat_features=category_columns,learning_rate=0.1                        | Вторая итерация                                                                  | 0.791                            | .........              |
