...
| 12    | ZONE1                  | Заполнить значением 0                                                   |
| 13    | ZONE2                  | Заполнить значением 0                                                   |
| 14    | TOP_PACK               | С помощью кластеризации определить возможное значение и свести в группы |
...
При третьем приближении было принято решение о кодировании всех категориальных признаков:
...
| 9   | LightGBM                         | 'learning_rate': 0.01, 'max_depth': 50,'min_data_in_leaf': 500, 'n_estimators': 200, 'num_leaves': 1200                                                                                           | Первая итерация                                                                  |0.77                        | .........              |
| 10  | CatBoost                         | iterations=52, eval_metric='AUC', cat_features=category_columns,learning_rate=0.1                        | Первая итерация                                                                  | 0.792                            | .........              |
| 11  | CatBoost                         | iterations=42, eval_metric='AUC', cat_features=category_columns,learning_rate=0.1                        | Вторая итерация                                                                  | 0.791                            | .........              |
